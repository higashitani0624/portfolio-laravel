...
@section('content')
<div class="w-3/5 mx-auto pt-60 h-screen mb-25">
    <div class="bg-gray-100 rounded mx-auto pb-10">
        <div class="col-md-8">
            <div class="w-2/5 mx-auto">
                <div class="text-center text-3xl py-10">{{ __('新規登録') }}</div>
                    ...
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="row mb-0">
                            <div class="col-md-6 offset-md-4 py-5 text-center">
                                <button type="submit" class="text-xl py-3 flex px-16 bg-yellow-500 rounded-full mx-auto text-center">
                                    {{ __('確認') }}
                                </button>
                            </div>
                        </div>
